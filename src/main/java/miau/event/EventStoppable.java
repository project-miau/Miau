...
/**
 * The most basic form of an stoppable Event. Stoppable events are called seperate from other events
 * and the calling of methods is stopped as soon as the EventStoppable is stopped.
 *
