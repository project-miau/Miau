...
public class SpotifyMod extends Module {
    ...
    private final ModeProperty backgroundColor = new ModeProperty("Background", 0, new String[] {"Average", "Spotify Grey", "Sync"});
    ...
    public final static File LASTFM_CREDS_DIR = new File(Minecraft.getMinecraft().mcDataDir, "Miau_LastFm.json");
    ...
    public void onEnabled() {
        ...
        if (user.equals("") || key.equals("")) {
            ...
            if (user.equals("") || key.equals("")) {
                Miau.notificationManager.pop("Error", "Please input Last.fm User and API Key in settings", NotificationType.WARN);
                this.toggle();
                return;
            }
        }
    ...
    public void onRender2DEvent(Render2DEvent event) {
        ...
        switch (backgroundColor.getModeString()) {
            ...
            case "Spotify Grey":
                ...
                break;
            case "Sync":
                RoundedUtils.drawRound(x + (albumCoverSize - 15), y, playerWidth + 15, height, 6, ColorUtil.rainbow(0));
                break;
        }
        ...
        float trackX = (float) (((x + albumCoverSize) - font22.width(currentTrackName)) +
        ...
        float artistX = (float) (((x + albumCoverSize) - font18.width(currentArtistName)) +
                ((font18.width(currentArtistName) + playerWidth) * scrollArtist.getOutput()));

        font18.draw(currentArtistName, needsToScrollArtist ? artistX : x + albumCoverSize + 4, y + 26, -1);
        ...
        if (api.currentMbid != null && !api.currentMbid.equals(lastDownloadedId)) {
            ...
            if (api.albumUrl != null && !api.albumUrl.isEmpty()) {
                final ThreadDownloadImageData albumCover = new ThreadDownloadImageData(null, api.albumUrl, null, new IImageBuffer() {
                    @Override
                ...
                mc.getTextureManager().loadTexture(currentAlbumCover = new ResourceLocation("lastfmAlbums/" + System.currentTimeMillis()), albumCover);
            }
        }
