...
/** Gaussian Bloom utility - ported from Tenacity 5.1 */
public class BloomUtil {

  private static final Minecraft mc = Minecraft.getMinecraft();

  public static ShaderUtils gaussianBloom =
      new ShaderUtils("miau:shaders/bloom.frag", "miau:shaders/vertex.vsh");
