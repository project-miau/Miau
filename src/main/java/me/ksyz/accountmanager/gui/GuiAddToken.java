...
public class GuiAddToken extends GuiScreen {
  ...
  public void initGui() {
    ...
    buttonList.add(
        new GuiButton(
            998, sr.getScaledWidth() / 2 - 100, sr.getScaledHeight() / 2 + 30, 200, 20, "Add"));
  }
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    drawCenteredString(
        ...
        "Add Token",
        width / 2,
        height / 2 - fontRendererObj.FONT_HEIGHT / 2 - fontRendererObj.FONT_HEIGHT * 2 - 14,
        11184810);
    ...
    if (status != null) {
      drawCenteredString(
          fontRendererObj,
          TextFormatting.translate(status),
          width / 2,
          height / 2 - fontRendererObj.FONT_HEIGHT / 2 - 14,
          -1);
    }
    ...
    if (cause != null) {
      ...
      drawString(
          fontRendererObj,
          TextFormatting.translate(cause),
          3,
    ...
    if (button.enabled) {
      if (button.id == 998) {
        if (task == null) {
          ...
          task =
              MicrosoftAuth.login(tokenField.getText(), executor)
