...
public class GuiMicrosoftAuth extends GuiScreen {
  ...
  public void initGui() {
    ...
    if (task == null) {
      ...
      task =
          MicrosoftAuth.acquireMSAuthCode(state, executor)
              .thenComposeAsync(
                  msAuthCode -> {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    drawCenteredString(
        ...
        width / 2,
        height / 2 - fontRendererObj.FONT_HEIGHT / 2 - fontRendererObj.FONT_HEIGHT * 2,
        11184810);
    ...
    if (status != null) {
      drawCenteredString(
          ...
          width / 2,
          height / 2 - fontRendererObj.FONT_HEIGHT / 2,
          -1);
    }
