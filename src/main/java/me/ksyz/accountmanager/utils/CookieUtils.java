...
public final class CookieUtils {
  ...
  /**
   * Parses the contents of an exported cookies file into an ordered {@code name -> value} jar.
   * Three common export shapes are supported:
   *
   * <ul>
   *   <li>Netscape / Mozilla {@code cookies.txt} (tab separated, the format produced by "Get
   *       cookies.txt" style browser extensions);
   *   <li>JSON exports (e.g. EditThisCookie / Cookie-Editor), either an array of objects or a
   *       single object with {@code name}/{@code value};
   *   <li>a raw {@code Cookie:} header string ({@code name=value; ...}).
   * </ul>
   */
