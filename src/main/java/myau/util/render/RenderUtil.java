...
public class RenderUtil {
  ...
  public static void drawEntityCircle(Entity entity, double radius, int segments, int color) {
    ...
    ShapeUtil.drawCircle(d2, d3, d4, radius, segments, color);
  }
  ...
  public static void drawCornerESP(EntityPlayer entity, float red, float green, float blue) {
    ...
    ShapeUtil.draw3DRect(width, height - 1.0F, width - 4.0F, height);
    ShapeUtil.draw3DRect(-width, height - 1.0F, -width + 4.0F, height);
    ShapeUtil.draw3DRect(-width, height, -width + 1.0F, height - 4.0F);
    ShapeUtil.draw3DRect(width, height, width - 1.0F, height - 4.0F);
    ShapeUtil.draw3DRect(width, -height, width - 4.0F, -height + 1.0F);
    ShapeUtil.draw3DRect(-width, -height, -width + 4.0F, -height + 1.0F);
    ShapeUtil.draw3DRect(-width, -height + 1.0F, -width + 1.0F, -height + 4.0F);
    ShapeUtil.draw3DRect(width, -height + 1.0F, width - 1.0F, -height + 4.0F);
    GlStateManager.color(0.0F, 0.0F, 0.0F);
    ShapeUtil.draw3DRect(width, height, width - 4.0F, height + 0.2F);
    ShapeUtil.draw3DRect(-width, height, -width + 4.0F, height + 0.2F);
    ShapeUtil.draw3DRect(-width - 0.2F, height + 0.2F, -width, height - 4.0F);
    ShapeUtil.draw3DRect(width + 0.2F, height + 0.2F, width, height - 4.0F);
    ShapeUtil.draw3DRect(width + 0.2F, -height, width - 4.0F, -height - 0.2F);
    ShapeUtil.draw3DRect(-width - 0.2F, -height, -width + 4.0F, -height - 0.2F);
    ShapeUtil.draw3DRect(-width - 0.2F, -height, -width, -height + 4.0F);
    ShapeUtil.draw3DRect(width + 0.2F, -height, width, -height + 4.0F);
    GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    GlStateManager.popMatrix();
  }
  ...
  public static void drawFake2DESP(EntityPlayer entity, float red, float green, float blue) {
    ...
    float height = 12.0F;
    ShapeUtil.draw3DRect(width, height, -width, height + 0.4F);
    ShapeUtil.draw3DRect(width, -height, -width, -height + 0.4F);
    ShapeUtil.draw3DRect(width, -height + 0.4F, width - 0.4F, height + 0.4F);
    ShapeUtil.draw3DRect(-width, -height + 0.4F, -width + 0.4F, height + 0.4F);
    GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    GlStateManager.popMatrix();
  }
    ...
    if (e instanceof EntityLivingBase) {
      ...
      if (type == 3) {
        ...
        if (type == 4) {
          ...
          ShapeUtil.drawCircle(x, y, z, 0.699999988079071D, 45, 1.5F, color, color == 0);
        } else {
          if (color == 0) {
