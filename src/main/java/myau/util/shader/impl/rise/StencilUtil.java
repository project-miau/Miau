...
public class StencilUtil {
  ...
  private static void recreate(final Framebuffer framebuffer) {
    ...
    GL30.glRenderbufferStorage(
        GL30.GL_RENDERBUFFER, GL30.GL_DEPTH_STENCIL, mc.displayWidth, mc.displayHeight);
    GL30.glFramebufferRenderbuffer(
        GL30.GL_FRAMEBUFFER, GL30.GL_STENCIL_ATTACHMENT, GL30.GL_RENDERBUFFER, depthBuffer);
    GL30.glFramebufferRenderbuffer(
