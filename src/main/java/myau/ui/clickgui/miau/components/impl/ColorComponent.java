...
public class ColorComponent extends Component {
  ...
  public void render() {
    ...
    ShapeUtil.drawRect(
        ...
        0xFF3C3C46);
    ShapeUtil.drawRect(boxX, boxY, boxX + PREVIEW_BOX_SIZE, boxY + PREVIEW_BOX_SIZE, getColorRGB());
  ...
  private void renderPickerContent(float cx, float cy) {
    ...
    ShapeUtil.drawRect(areaLeft, sqTop, sqRight, sqBottom, hueRGB);
    ...
    ShapeUtil.drawRect(indX - 2, indY, indX + 3, indY + 1, 0xFFFFFFFF);
    ShapeUtil.drawRect(indX, indY - 2, indX + 1, indY + 3, 0xFFFFFFFF);
    ...
    ShapeUtil.drawRect(hueLeft - 1, hueIndY - 1, hueRight + 1, hueIndY + 2, 0xFFFFFFFF);
  }
