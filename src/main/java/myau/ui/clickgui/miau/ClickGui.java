...
import myau.ui.clickgui.miau.components.impl.BindComponent;
import myau.ui.clickgui.miau.components.impl.CategoryComponent;
import myau.ui.clickgui.miau.components.impl.ModuleComponent;
import myau.ui.clickgui.miau.components.impl.SearchBarComponent;
  ...
  public void drawScreen(int x, int y, float p) {
    ...
    if (hudModule != null && hudModule.shaders.getValue()) {
      myau.util.shader.RenderSystem.renderBloom(
          ...
          hudModule.bloomCompression.getValue().floatValue(),
          () -> {
    ...
    String version = myau.Myau.version;
    this.fontRendererObj.drawStringWithShadow("Username: " + username, 2, this.height - 22, -1);
    this.fontRendererObj.drawStringWithShadow("Version: " + version, 2, this.height - 10, -1);
  }
