      ...
      runOnClientThread(
          () ->
              ChatUtil.sendFormatted(
                  Myau.clientName + "Failed to list user configs: &c" + e.getMessage() + "&r"));
    }
  }
  ...
  private void loadConfig(String input) {
    try {
      ...
      runOnClientThread(
          () ->
              ChatUtil.sendFormatted(
                  Myau.clientName + "Failed to load user config: &c" + e.getMessage() + "&r"));
    }
  }
  ...
  private void showInfo(String input) {
    try {
      ...
      runOnClientThread(
          () ->
              ChatUtil.sendFormatted(
                  Myau.clientName + "Failed to get user config info: &c" + e.getMessage() + "&r"));
    }
  }
